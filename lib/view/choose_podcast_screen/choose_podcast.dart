...
class _ChoosePodcastState extends State<ChoosePodcast> {
  ...
  final List<Map<String, String>> artists = [
    ...
    {"name": "Intelerks", "image": ImageConstants.intelerks},
    {"name": "Rottan", "image": ImageConstants.rottan},
    {"name": "The Ranveer show", "image": ImageConstants.ranveer},
    {"name": "Tedx Talk", "image": ImageConstants.tedx},
  ];
